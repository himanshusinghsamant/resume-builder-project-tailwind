    ...
    return (
      <div className="flex justify-center  ">
        <div className="resume-container bg-slate-100 w-[85%] h-[1050px]  mt-5 md:h-[900px] md:w-[55%] lg:w-[50%]">
          <div className="resume-header relative h-[80px] bg-slate-300 ">
            <div className="  name-sec ml-[25%] flex justify-around w-[65%] pt-3 pl-3 md:ml-[25%] md:w-[67%] lg:w-[55%]">
              <span className="text-orange-600 text-xl font-light tracking-widest md:text-3xl">DANI</span>
              <span className="text-orange-700 text-xl font-semibold tracking-widest md:text-3xl">
                SCHWAIGER
              </span>
            </div>
            ...
            <div className="profile-sec absolute left-6 top-2 bg-slate-600 w-16 h-16 rounded-full">
              <img className="rounded-full" src="https://cdn3d.iconscout.com/3d/premium/thumb/young-businessman-avatar-5692602-4743371.png" alt="" />
            </div>
          </div>
          <div className="main-sec-1 flex flex-row-reverse justify-between w-[100%] md:px-5">
            ...
            <div className="box-2 w-[60%] pl-3 mt-5">
              <h1 className="text-orange-600 font-semibold mb-2 tracking-widest">PROFILE</h1>
              <p className="text-sm">
          ...
          <h1 className=" text-orange-600 font-semibold tracking-widest mb-2">EXPERIENCE</h1>
          ...
          <div className="main-sec-2 mt-3 flex flex-row-reverse justify-between w-[100%] md:px-5">
            <div className="box-1 pr-2 w-[35%]">
              <h1 className="text-orange-600 font-semibold tracking-widest mb-2">SKILLS</h1>
            ...
            <div className="box-2 pl-3 w-[60%]">
              <h1 className="text-orange-600 font-semibold tracking-widest mb-2">EDUCATION</h1>
              <div>
