import './Template_2.style.css'

const Template_2 = () => {
    return (
      <div className="flex justify-center  ">
        <div className="resume-container bg-yellow-100 w-[85%] h-[1090px]  mt-5 md:h-[900px] md:w-[55%] lg:w-[50%]">
          <div className="resume-header relative h-[80px] bg-yellow-200 ">
            <div className="name-sec flex justify-around w-[65%] pt-3 pl-3 md:w-[67%] md:ml-7 lg:w-[55%]">
              <span className=" text-purple-700 text-xl font-light tracking-widest md:text-3xl ">DANI</span>
              <span className="text-purple-800 text-xl font-semibold tracking-widest md:text-3xl">
                SCHWAIGER
              </span>
            </div>
            <span className="text-xs pl-5 tracking-widest md:pl-16">WEB DEVELOPER</span>
            <div className="profile-sec absolute right-6 top-2 bg-slate-600 w-16 h-16 rounded-full">
              <img className="rounded-full" src="https://media.istockphoto.com/id/1296058958/vector/happy-young-woman-watching-into-rounded-frame-isolated-on-white-3d-vector-illustration.jpg?s=612x612&w=0&k=20&c=x9lmmoKVqxRro-G3S48IWIKQiykb2Yv1CkuiizDJ6gw=" alt="" />
            </div>
          </div>
          <div className="main-sec-1 flex justify-between w-[100%] md:px-5">
            ...
            <div className="box-2 w-[60%] mt-5">
              <h1 className="text-purple-700 font-semibold mb-2 tracking-widest">PROFILE</h1>
              <p className="text-sm">
          ...
          <h1 className=" text-purple-700 font-semibold tracking-widest mb-2">EXPERIENCE</h1>
          ...
          <div className="main-sec-2 mt-3 flex justify-between w-[100%] md:px-5">
            <div className="box-1 pl-2 w-[35%]">
              <h1 className="text-purple-700 font-semibold tracking-widest mb-2">SKILLS</h1>
            ...
            <div className="box-2 w-[60%]">
              <h1 className="text-purple-700 font-semibold tracking-widest mb-2">EDUCATION</h1>
              <div>
